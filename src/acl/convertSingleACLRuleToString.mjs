...
import {mapProtocolNameToInteger} from "../util/map/protocol.mjs"
import validateSingleACLRule from "./validateSingleACLRule.mjs"

export default function(context, normalized_rule) {
	let parts = []
